...
import { Id } from "@present/backend/convex/_generated/dataModel";
...
import { ScriptureInput, ScriptureInputRef } from "./ScriptureInput";
  ...
  forwardRef<ScripturePanelRef, ScripturePanelProps>(function ScripturePanel(
    ...
    const onSpeechResult = useCallback(
      (result: { transcript: string; isFinal: boolean }) => {
        ...
        if (inputRef.current) {
          inputRef.current.setValue(result.transcript);
        }
      },
      []
    );
    ...
    return (
      <div className="h-full relative overflow-hidden">
        <ResizablePanelGroup
          ...
          className="h-full"
          id="present-scripture-layout"
        >
          {/* Downloader Sidebar */}
          <ResizablePanel defaultSize="33" minSize="30" maxSize="40">
